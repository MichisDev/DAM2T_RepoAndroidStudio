...
import com.example.ut01_reciclerviewplanetas.R
import modelo.Planet

class AdapterPlanet (private val planets: MutableList<Planet>) :
    RecyclerView.Adapter<AdapterPlanet.PlanetViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlanetViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_planeta, parent, false) // aqui a el iten plat 2
    ...
    override fun onBindViewHolder(holder: PlanetViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (selectedItems.contains(position)) {
                ...
                selectedItems.add(position) // para guardar posicione siguiente ventana
            }
